...
`technical-docs` but allows stronger changes to structure, pacing, and explanation.

Use an existing draft or supplied authoritative context. The skill does not research independently.
