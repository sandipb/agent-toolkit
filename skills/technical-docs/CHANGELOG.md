...
- Clarify routing for concise fragments and preserve review-only mode throughout editorial checks.
- Clarify additions during editing, delegation context, and independence from prior assessments.
...
- Added source-bounded composition, preservation-safe editing, review, and editorial orchestration for documentation.
